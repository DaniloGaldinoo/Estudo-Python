# Exercício 59 - Jogo da Adivinhação
# Curso: Python
# Autor: Danilo Galdino
# Descrição: O computador sorteia um número
# entre 0 e 10 e o jogador deve tentar adivinhar.
# O programa informa a quantidade de tentativas.
