# Exercício 65 - Conta e Soma
# Curso: Python
# Autor: Danilo Galdino
# Descrição: Permite ao usuário inserir números
# continuamente e calcula a soma total até que
# seja digitado o valor 999 para encerrar.
